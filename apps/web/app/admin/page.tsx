...
export default async function AdminPage() {
  ...
  return (
    <section className={styles.management} aria-labelledby="management-title">
      <div className={styles.managementTitle}><h1 id="management-title">文章管理</h1><a href="/admin/taxonomy">分类与标签</a><a href="/admin/about">关于页</a><a href="/admin/new">新建草稿</a></div>
