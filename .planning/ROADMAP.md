...
- [ ] 03-01-PLAN.md — 建立不可跳过的 Phase 3 本地数据库验证器，并实现公开分发投影与 RSS 合同。
...
- [ ] 03-03-PLAN.md — 固化 Phase 3 全量本地验收、同源 URL、禁止外联和精确清理门禁。
...
| 3. Distribution and Portability | 0/4 | Not started | - |
